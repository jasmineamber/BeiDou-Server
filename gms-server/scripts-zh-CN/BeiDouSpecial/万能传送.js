...
var monstermaps = Array(
	Array(104040000, 500, "射手训练场#r（500金币）         #b适合 1 ~ 15 级玩家"),
	Array(101010100, 580, "大木林#r（580金币）             #b适合 8 ~ 15 级玩家"),
	Array(101030401, 580, "东部岩石路Ⅱ#r（580金币）             #b适合 20 ~ 25 级玩家"),
	Array(103000101, 680, "地铁<第1地区>#r（680金币）      #b适合 20 ~ 25 级玩家"),
	Array(220010500, 780, "露台大厅#r（780金币）           #b适合 25 ~ 30 级玩家"),
	Array(101030001, 880, "野猪的领土Ⅱ#r（880金币）       #b适合 25 ~ 35 级玩家"),
	Array(103000105, 980, "地铁<第4地区>#r（980金币）      #b适合 35 ~ 50 级玩家"),
	Array(100040103, 1080, "猴子森林Ⅱ#r（1080金币）        #b适合 35 ~ 50 级玩家"),
	Array(220040000, 1180, "时间之路1#r（1180金币）         #b适合 45 ~ 60 级玩家"),
	Array(105040306, 1280, "巨人之林#r（1280金币）          #b适合 50 ~ 65 级玩家"),
	Array(250010304, 2280, "流浪熊的地盘#r（2280金币）      #b适合 55 ~ 75 级玩家"),
	Array(251010402, 2380, "海盗团老巢2#r（2380金币）       #b适合 65 ~ 75 级玩家"),
	Array(541010010, 2580, "幽灵船2#r（2580金币）           #b适合 60 ~ 80 级玩家"),
	Array(600020300, 2680, "狼蛛洞穴#r（2680金币）          #b适合 80 ~ 90 级玩家"),
	Array(240010500, 2780, "山羊峡谷#r（2780金币）          #b适合 85 ~ 100 级玩家"),
	Array(230040100, 2880, "深海峡谷2#r（2880金币）         #b适合 90 ~ 100 级玩家"),
	Array(551030100, 2980, "阴森世界入口#r（2980金币）      #b适合 95 ~ 120 级玩家"),
	Array(240030102, 3080, "消失的树林#r（3080金币）        #b适合 100 ~ 120 级玩家"),
	Array(240040511, 3280, "被遗忘的龙之巢#r（3280金币）    #b适合 105 ~ 130 级玩家"),
	Array(541020000, 3580, "乌鲁城入口#r（3580金币）        #b适合 105 ~ 150 级玩家")
);
...
var beginner_townmaps = Array(
	Array(104000000, 100, "明珠港               #r（消耗1百金币）#b"),
	Array(100000000, 100, "射手村               #r（消耗1百金币）#b"),
	Array(101000000, 80, "魔法密林             #r（消耗80金币）#b"),
	Array(102000000, 100, "勇士部落             #r（消耗1百金币）#b"),
	Array(103000000, 100, "废弃都市             #r（消耗1百金币）#b"),
	Array(120000000, 80, "诺特勒斯号码头       #r（消耗80金币）#b"),
);

var townmaps = full_townmaps;
//------------------------------------------------------------------------
